...
<center><a href="/students/indexDraft.php?passCode=<?php echo $randomString ?>&contactEmail=<?php echo $contactEmail ?>"><button type="button">Register your Child</button></a></center>
<br/>
<br/>
...
Please use this passcode to register your students
