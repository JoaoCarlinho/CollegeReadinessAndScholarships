...
?>
                            <a href="registeredDraft.php?groupCount=<?php echo $groupCount ?>&contactFirstName=<?php echo $contactFirstName ?>&contactLastName=<?php echo $contactLastName ?>&contactEmail=<?php echo $contactEmail ?>&contactMobile=<?php echo $contactMobile ?>&affiliateType=<?php echo $affiliateType ?>&affiliateName=<?php echo $affiliateName ?>
                        ...
                        <div>
                            <a href="gc.php" ><button type="button ">Cancel</button></a>
                        </div>
                </center>
